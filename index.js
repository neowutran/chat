...
function process(text){
    ...
    text = text.replace(/#n\{([A-Za-z0-9\.\-_ ]+)\}/g, "</FONT><FONT FACE=\"$ChatFont\" COLOR=\"#fc7678\" KERNING=\"0\" ><a href='asfunction:chatNameAction,\$1@0@0'>\$1</a></FONT><FONT>");
    ...
    text = text.replace(/#hi\{([^\}]*)\}/g, "</FONT><FONT COLOR=\"#cc33ff\"><A HREF=\"asfunction:chatLinkAction@335@0@Hi\">Hi</A></FONT><FONT>");
